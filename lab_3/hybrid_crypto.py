...
class HybridCrypto:
    def __init__(self, config : dict, file_manager : FileManager) -> None:
        '''
        Initializes HybridCrypto with configuration and file manager.
        :param config: Configuration dictionary
        :param file_manager: FileManager instance for file operations
        :return: None
        '''
        self.config = config
    ...
    def generate_keys(self) -> None:
        '''
        Generates keys and saves all keys to files.
        :return: None
        '''
    ...
    def encrypt_file(self) -> None:
        '''
        Encrypts the text file  and saves the encrypted file.
        :return: None
        '''
    ...
    def decrypt_file(self) -> None:
        '''
        Decrypts the encrypted file and saves the decrypted file.
        :return: None
        '''
        private_key = self.file_manager.load_private_key_pem(self.config['private_key'])
        encrypted_cast_key = self.file_manager.read_file(self.config['symmetric_key'])
