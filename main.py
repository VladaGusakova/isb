...
def analyze_sequence(bits : str) -> dict:
    '''
    ...
    return {
        ...
        'longest_seq_ones_in_block_test': longest_seq_ones_in_block_test(bits)
    }
...
def main() -> None:
    ...
    results = {
        'cpp_sequence': analyze_sequence(cpp_bits),
        'java_sequence': analyze_sequence(java_bits)
    }
